...
const Navbar = ({
  ...
  return (
    <nav className="sticky top-0 z-50 bg-black text-white font-sans backdrop-blur-sm border-b border-white/10">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4 font-bold">
                <Link
                  href="/"
                  className="px-3 py-2 rounded-md text-md transform transition-transform duration-200 hover:scale-110"
                >
                  Home
                </Link>
