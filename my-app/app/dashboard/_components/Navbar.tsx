      ...
      {isOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/technical-interview" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700 hover:text-white">Technical Interview</Link>
            <Link href="/hr-interview" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700 hover:text-white">HR Interview</Link>
          </div>
