...
export async function POST(request: Request) {
    try {
        ...
        if (interviewType === 'technical') {
            inputPrompt = `Role: ${role}, Experience Level: ${experience}. Generate 2 technical interview questions appropriate for this role and experience level, along with detailed answers.Answers should be one paragraph. Provide the response in JSON format as an array of objects with 'question' and 'answer' fields: [{'question':'...','answer':'...'}]`;
        } else {
